...
wget https://github.com/edumendaya/workshopDMFTS/raw/refs/heads/main/modE2W_Linux.sh
ln -s ../fsc28
ln -s ../../sfs/threePop_fold/fastsimcoal2/three_pop_MSFS.obs modE2W_MSFS.obs
chmod +x modE2W.sh
